...
echo "<TH width=150>วันที่ซื้อ</TH>";
 echo  "</tr>";
echo "</THEAD>";
...
while( $f = mysqli_fetch_assoc($objQuerycase) ) {
 ...
 echo  "<tr>";
    echo "<td><h4>" .$f["name_customer"] .  "</h4></td> ";
    echo "<td><h4>" .$f["numbet_idsell"] .  "</h4></td> ";
    echo "<td><h4>" .$f["numbet_phone_customer"] .  "</h4></td> ";
    echo "<td><h4>" .$f["times_u"] .  "</h4></td> ";
